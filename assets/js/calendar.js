$.getScript('http://arshaw.com/js/fullcalendar-1.6.4/fullcalendar/fullcalendar.min.js',function(){
  ...
  $('#calendar').fullCalendar({
    ...
    googleCalendarApiKey: 'AIzaSyAnYOplsoQ5rdHuS7n_wj9U38sEomK_VwA',
    contentHeight: 1200,
    ...
    allDaySlot: false,
    events: {
      googleCalendarId: 'lorqoocesambfpesb2ppgifj94@group.calendar.google.com'
    },

    // events: [
    //   //Monday
    //   {
    //     title: 'M.S Work. Meeting by appt. only. Click to email.',
    //     start: new Date(2015, 7, 17 , 9, 0),
    //     end: new Date(2015, 7, 17, 13, 0),
    //     allDay: false,
    //     color: '#aaa',
    //     url: "mailto:cpiggott@ksu.edu?Subject=Schedule%20CIS%20Meeting%20Monday"
    //   },
    //   {
    //     title: 'Lunch',
    ...
    //     allDay: false,
    //     color: '#aaa',
    //     url: "mailto:cpiggott@ksu.edu?Subject=Schedule%20CIS%20Meeting%20Friday"
    //   },
    //   {
    //     title: 'Lunch',
